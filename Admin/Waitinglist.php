                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          {  echo "<tr>";
                             ...
                             echo "<td><a href='AllowVendor.php?id={$value['vendor_id']}' class='btn btn-round btn-primary'>Allow</a></td>";
                             echo "<td><a href='deleteVendor.php?id={$value['vendor_id']}' class='btn btn-round btn-danger'>Delete</a></td>";
                             echo "</tr>";
                          }
                          ?>
                        </tbody>
